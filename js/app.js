(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__slider")) new core(".slider-main__slider", {
            ...
            loop: true,
            pagination: {
                el: ".controls-slider__bullets",
                clickable: true
            },
            navigation: {
                prevEl: ".controls-slider__left",
                nextEl: ".controls-slider__right"
            },
            on: {}
        });
        if (document.querySelector(".slider-rooms__slider")) new core(".slider-rooms__slider", {
            ...
            navigation: {
                prevEl: ".arrows-rooms__left",
                nextEl: ".arrows-rooms__right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".tips__slider")) new core(".tips__slider", {
            ...
            navigation: {
                prevEl: ".tips__arrows_left",
                nextEl: ".tips__arrows_right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
...
***************************************************************************** */
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (targetElement.closest("#list-link_01")) {
            targetElement.closest("#list-link_01").classList.toggle("_open");
            e.preventDefault;
        } else if (targetElement.closest("#list-link_02")) {
            targetElement.closest("#list-link_02").classList.toggle("_open");
            e.preventDefault;
        }
        if (targetElement.closest(".link-menu__item_back")) {
